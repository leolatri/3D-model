...
1. [Введение](#введение)
2. [Создание HTML файла](#создание-html-файла)
3. [Создание JSON и Webpack файлов](#создание-json-и-webpack-файлов)
4. [Создание JS файла](#создание-js-файла)
## Введение
...
let width = 1400;
let height = 800;```
    <br><br> 5) Создаем экземпляр рендеринга, задавая ему значение холста и сглаживания (для 3d графики очень важный аспект).
